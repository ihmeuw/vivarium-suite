...
from vivarium.validation.comparison import Comparison
from vivarium.validation.constants import DRAW_INDEX, SEED_INDEX
from vivarium.validation.data_loader import DataSource
from vivarium.validation.visualization.plot_utils import (
...
class TestPlotComparison:
    def test_valid_type(self, sample_comparison: Comparison, mocker: MockerFixture) -> None:
        ...
        mock_line_plot = mocker.patch(
            "vivarium.validation.visualization.plot_utils._line_plot"
        )
...
class TestLinePlot:
    def test_subplots_true(
        ...
        mock_rel_plot = mocker.patch("vivarium.validation.visualization.plot_utils._rel_plot")
