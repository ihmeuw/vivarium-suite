...
class LBWSGDistribution(PolytomousDistribution):
    ...
    Extend :class:`~vivarium.public_health.causal_factor.distributions.PolytomousDistribution`
...
class LBWSGRisk(Risk):
    ...
    Extend :class:`~vivarium.public_health.risks.base_risk.Risk` with LBWSG-specific
