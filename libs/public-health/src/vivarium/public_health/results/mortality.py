...
from vivarium.public_health.disease import DiseaseState, RiskAttributableDisease
from vivarium.public_health.disease.state import ExcessMortalityState
...
class MortalityObserver(PublicHealthObserver):
    ...
    :class:`~vivarium.public_health.results.stratification.ResultsStratifier`. The
    ...
    def register_observations(self, builder: Builder) -> None:
        ...
        :class:`ResultsStratifier <vivarium.public_health.results.stratification.ResultsStratifier>`),
