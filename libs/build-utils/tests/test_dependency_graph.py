...
def test_load_libs_collects_only_in_tree_upstreams(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_load_libs_canonicalizes_dep_name_to_upstream(
    make_monorepo: MonorepoFactory,
) -> None:
...
# get_reachable_upstreams                                                           #
# --------------------------------------------------------------------------- #
def test_get_reachable_upstreams_includes_transitive_deps(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_reachable_upstreams_excludes_unrelated_libs(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_reachable_upstreams_includes_extra_only_deps(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_reachable_upstreams_excludes_target_itself(
    make_monorepo: MonorepoFactory,
) -> None:
...
# get_editable_upstreams                                                            #
# --------------------------------------------------------------------------- #
def test_get_editable_upstreams_selects_changed_reachable_compatible(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_excludes_unchanged_reachable_dep(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_excludes_changed_unreachable_lib(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_selects_transitively_reachable_changed(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_empty_when_no_changed_upstreams(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_hard_fails_on_pin_conflict(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_conflict_message_names_upstream_version_and_pin(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_detects_transitive_conflict(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_raises_keyerror_for_unknown_target(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_editable_upstreams_raises_keyerror_for_unknown_changed(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_release_order_preserves_input_order_for_independent_libraries(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_release_order_ignores_libraries_outside_the_batch(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_release_matrix_wait_for_empty_for_independent_library(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_get_release_matrix_raises_keyerror_for_unknown_library(
    make_monorepo: MonorepoFactory,
) -> None:
...
def test_build_install_plan_installs_each_upstream_editable() -> None:
...
def test_build_install_plan_sets_pretend_version_per_upstream() -> None:
...
def test_build_install_plan_applies_editable_compat_per_library() -> None:
...
# --------------------------------------------------------------------------- #
def test_discover_libs_dir_from_library_subdir(
...
def test_cli_editable_install_clean_exit_on_unknown_library(
    make_monorepo: MonorepoFactory, capsys: pytest.CaptureFixture[str]
) -> None:
...
def test_cli_release_matrix_clean_exit_on_unknown_library(
...
def test_cli_verify_editable_passes_when_upstreams_editable(
    make_monorepo: MonorepoFactory, monkeypatch: pytest.MonkeyPatch
) -> None:
...
def test_cli_verify_editable_fails_when_upstream_from_pypi(
    make_monorepo: MonorepoFactory,
    monkeypatch: pytest.MonkeyPatch,
    capsys: pytest.CaptureFixture[str],
) -> None:
...
def test_cli_verify_editable_noop_when_no_upstreams(
    make_monorepo: MonorepoFactory, capsys: pytest.CaptureFixture[str]
) -> None:
