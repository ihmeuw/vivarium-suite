...
simulation.  The :class:`~vivarium.artifact.artifact.Artifact` provides
...
:class:`~vivarium.artifact.artifact.Artifact`. You'll access data in
...
:class:`~vivarium.artifact.artifact.Artifact` tools, we'll
...
Now we have an :class:`~vivarium.artifact.artifact.Artifact` object,
...
:class:`~vivarium.artifact.artifact.Artifact` on its creation and
...
::
    ...
    Traceback (most recent call last):
      ...
      File "/home/kate/code/vivarium/vivarium/src/vivarium/artifact/artifact.py", line 75, in load
        raise ArtifactException(f"{entity_key} should be in {self.path}.")
    vivarium.artifact.ArtifactException: a.fake.key should be in tests/dataset_manager/artifact.hdf.

Writing data
------------

To write new data to an artifact, use the
:meth:`~vivarium.artifact.artifact.Artifact.write`
...
::
    ...
    Traceback (most recent call last):
      File "<stdin>", line 1, in <module>
      File "/home/kate/code/vivarium/vivarium/src/vivarium/artifact/artifact.py", line 105, in write
        raise ArtifactException(f'{entity_key} already in artifact.')
    vivarium.artifact.ArtifactException: locations.names already in artifact.

If the key you want to write to is already in the artifact, you'll want to
use the :meth:`~vivarium.artifact.artifact.Artifact.replace` method
instead of :meth:`~vivarium.artifact.artifact.Artifact.write`. This
...
Like :meth:`~vivarium.artifact.artifact.Artifact.load` and
:meth:`~vivarium.artifact.artifact.Artifact.write`,
:meth:`~vivarium.artifact.artifact.Artifact.remove` is based on keys.
