...
.. sidebar:: Decision Points
    ...
    :class:`RandomnessStream <vivarium.engine.framework.randomness.stream.RandomnessStream>`
...
A :class:`RandomnessStream <vivarium.engine.framework.randomness.stream.RandomnessStream>`,
...
randomness system: in getting and using :class:`RandomnessStreams <vivarium.engine.framework.randomness.stream.RandomnessStream>`
...
aptly named :func:`register_simulants <vivarium.engine.framework.randomness.interface.RandomnessInterface.register_simulants>`,
...
:func:`get_stream <vivarium.engine.framework.randomness.interface.RandomnessInterface.get_stream>` to do this. Let's
...
use a :class:`RandomnessStreams <vivarium.engine.framework.randomness.stream.RandomnessStream>`
