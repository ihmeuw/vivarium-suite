...
model_specification
  ...
  :class:`~vivarium.config_tree.main.ConfigTree`, the internal
...
components
  ...
  :class:`~vivarium.config_tree.main.ConfigTree`
...
configuration
  ...
  :class:`~vivarium.config_tree.main.ConfigTree` representation. See
...
plugins
  ...
  :class:`~vivarium.config_tree.main.ConfigTree` and are
