...
project = "vivarium.fuzzy_checker"
author = "The vivarium developers"
copyright = "2023, Institute for Health Metrics and Evaluation"

version = importlib.metadata.version("vivarium-fuzzy-checker")
release = version
...
texinfo_documents = [
    (
        ...
        author,
        project,
        "Statistical fuzzy-checking utilities for verifying Vivarium simulation outputs.",
        "Miscellaneous",
    ),
]
