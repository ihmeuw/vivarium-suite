---
name: _claim_auditor
description: "Use when: auditing a single AI-plaintext unit (a skill, agent, a plugin README, or CLAUDE.md) for drift — extracting its load-bearing checkable claims and verifying each against its upstream source, returning structured findings. Spawned per-unit by the /viv:repo-maintenance skill."
tools:
